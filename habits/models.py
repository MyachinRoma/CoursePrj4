...
class Habit(models.Model):
    ...
    time = models.DateTimeField(
        ...
        help_text="Enter the time when a habit"
                  "should be performed."
                  "In case a habit should be"
                  "performed several times "
                  "per day, the end time"
    ...
    action = models.CharField(
        max_length=200, verbose_name="action",
        help_text="Enter the action to perform."
    )
    is_pleasant = models.BooleanField(
        verbose_name="pleasant or not",
        help_text="Select whether a"
                  "habit is pleasant or not. "
    ...
    related_habit = models.ForeignKey(
        ...
        help_text="Select a related pleasant habit"
                  "(as a reward). For good habits only!",
        blank=True,
        null=True,
    )
